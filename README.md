...
* [6. View Commit History](#6-view-commit-history)
* [7. Display Differences Between File Versions](#7-display-differences-between-file-versions)
* [8. Ignore Files with .gitignore](#8-ignore-files-with-gitignore)
         + [Example .gitignore:](#example-gitignore)
* [9. Keeping Empty Folders in Git](#9-keeping-empty-folders-in-git)
         + [🔧 Problem:](#🔧-problem)
         + [Solution: Use a placeholder file, like .git-keep](#solution-use-a-placeholder-file-like-git-keep)
         + [Example:](#example)
* [10. Modify the Last Commit Without Changing the Message](#10-modify-the-last-commit-without-changing-the-message)
* [11. Revert the main branch to a previous commit](#11-revert-the-main-branch-to-a-previous-commit)
* [12. Create and switch to a new branch](#12-create-and-switch-to-a-new-branch)
* [13. List all local branches](#13-list-all-local-branches)
* [14. List all the remote brances](#14-list-all-the-remote-brances)
* [15. Reset all changes after last commit](#15-reset-all-changes-after-last-commit)
* [16. Remove GIT History (Caution it delete all the commit history)](#16-remove-git-history-caution-it-delete-all-the-commit-history)
* [17. Bare repository](#17-bare-repository)
* [18. Git bisect](#18-git-bisect)
* [19. Reduce Git repository size](#19-reduce-git-repository-size)
* [20. Revert](#20-revert)
